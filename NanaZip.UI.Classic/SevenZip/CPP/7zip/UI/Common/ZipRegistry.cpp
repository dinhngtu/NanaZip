...
// **************** NanaZip Modification Start ****************
static LPCTSTR const kEnforcedInfoKeyName = TEXT("Enforced");
// **************** NanaZip Modification End ****************
...
void CContextMenuInfo::Load()
{
  ...
  // **************** NanaZip Modification Start ****************
  CKey enforcedKey;
  OpenMachineKey(enforcedKey, kEnforcedInfoKeyName);
  // **************** NanaZip Modification End ****************
  ...
  // **************** NanaZip Modification Start ****************
  if (!enforcedKey || enforcedKey.QueryValue(kWriteZoneId, WriteZone) != ERROR_SUCCESS)
